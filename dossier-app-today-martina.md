...
- **Apariencia de Today** (selecciones independientes; se guardan en el dispositivo):
  ...
  - La barra cubre siempre toda la franja horaria del día. En días de cole, el horario escolar aparece como un tramo **comprimido y rayado** («cole»; en la barra de la niña, un túnel en el que entra y del que sale), de modo que por la mañana también se ve todo lo que viene por la tarde. Días sin cole: toda la franja, sin hueco.
